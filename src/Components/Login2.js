...
export default function Login2() {
    const InputWithFixedLabel = ({ id, placeholder }) => {
        ...
        <div className="relative mb-4" data-te-input-wrapper-init>
            ...
            className={`pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out transform origin-top ${
                isFocused || inputValue ? 'scale-75 -translate-y-3' : ''
            }`}
            >
            {placeholder}
            </label>
            ...
            <div className="w-full">
              <div className="block rounded-lg bg-white shadow-lg dark:bg-neutral-800">
                <div className=" g-0 lg:flex lg:flex-wrap">
                  <div className="relative bg-gradient-to-r from-orange-400 to-pink-600 flex items-center rounded-b-lg lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none">
                    <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                      <div className="custom-shape w-full absolute top-0 left-0 z-10"></div>
                      <h2 className="mt-20 mb-6 text-xl text-black font-semibold">
                  ...
                  <div className="px-4 md:px-0 lg:w-6/12">
                    <div className="md:mx-6 md:p-12">
                      ...
                      <form>
                        ...
                        <InputWithFixedLabel id="exampleFormControlInput1" placeholder="Username" />
                        <InputWithFixedLabel id="exampleFormControlInput2" placeholder="Password" />
